...
mixin _$ProductDto {
 ...
 int get id; String get title; String get imageUrl; double get price; DateTime get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,imageUrl,price,createdAt);

@override
String toString() {
  return 'ProductDto(id: $id, title: $title, imageUrl: $imageUrl, price: $price, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 int id, String title, String imageUrl, double price, DateTime createdAt
});
...
/// Create a copy of ProductDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? imageUrl = null,Object? price = null,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String title,  String imageUrl,  double price,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProductDto() when $default != null:
return $default(_that.id,_that.title,_that.imageUrl,_that.price,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String title,  String imageUrl,  double price,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _ProductDto():
return $default(_that.id,_that.title,_that.imageUrl,_that.price,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String title,  String imageUrl,  double price,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _ProductDto() when $default != null:
return $default(_that.id,_that.title,_that.imageUrl,_that.price,_that.createdAt);case _:
  return null;
...
class _ProductDto implements ProductDto {
  const _ProductDto({required this.id, required this.title, required this.imageUrl, required this.price, required this.createdAt});
...
/// Create a copy of ProductDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? imageUrl = null,Object? price = null,Object? createdAt = null,}) {
